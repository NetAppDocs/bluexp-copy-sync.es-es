...
| \https://console.bluexp.netapp.com/ \https://netapp-cloud-account.auth0.com | Para ponerse en contacto con la clasificación de BlueXP cuando usas la clasificación a fin de seleccionar los archivos de origen de una nueva relación de sincronización. 
